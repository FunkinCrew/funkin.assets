...
This folder holds all the characters! Character data, health icons, graphics, and scripts all go together and each character gets its own folder. Add subfolders as appropriate.
